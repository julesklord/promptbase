...
function openFullViewModal(p, models) {
  ...
  card.innerHTML = `
    ...
    <div class="card-author">
      ...
      ${(p.usecase || [])
        ...
        .map(
          (t) =>
            `<span style="color:var(--text3);font-size:9px;background:var(--bg3);padding:1px 5px;">${escapeHtml(t)}</span>`,
        )
        .join("")}
    </div>
  `;
