...
try {
    ...
    execSync('git commit -m "chore(community): community organic vote increments"', { stdio: 'inherit' });
...
const newPrompts = [
    {
        ...
        payload: {
            ...
            "description": "Compile high-performance Rust logic to WASM and bridge it seamlessly with frontend bundlers.",
    ...
    },
    {
        ...
        payload: {
            ...
            "description": "Implement intrinsic web design replacing strict media queries with semantic container queries.",
    ...
    },
    {
        ...
        payload: {
            ...
            "description": "Store and query AI knowledge vectors natively inside PostgreSQL without external vector databases.",
    ...
    },
    {
        ...
        payload: {
            ...
            "description": "Harden web application security by engineering a strict, nonce-based CSP header configuration.",
